...
app.config['MAIL_USERNAME'] = os.environ.get('MAIL_USERNAME', 'aryan.stark0325@gmail.com')
app.config['MAIL_PASSWORD'] = os.environ.get('MAIL_PASSWORD', 'upaegiooempqcmgy')
app.config['MAIL_DEFAULT_SENDER'] = os.environ.get('MAIL_USERNAME', 'aryan.stark0325@gmail.com')
# ── Platform fee config ──
